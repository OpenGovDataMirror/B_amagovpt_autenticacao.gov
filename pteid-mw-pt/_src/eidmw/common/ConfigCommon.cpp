...
//GENERAL
  ...
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GENERAL_PTEID_CACHE_ENABLED = {EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_CACHE_ENABLED, 1};
#ifdef WIN32
  ...
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GENERAL_PINPAD_ENABLED = { EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_PINPAD_ENABLED, 1 };
...
//LOGGING
  ...
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_LOGGING_FILESIZE  	=	{EIDMW_CNF_SECTION_LOGGING,	EIDMW_CNF_LOGGING_FILESIZE,		1048576};
...
//GUI
  ...
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GUITOOL_USESYSTEMSCALE	=	{EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_USESYSTEMSCALE,			1};
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GUITOOL_APPLICATIONSCALE	=	{EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_APPLICATIONSCALE,			0};
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GUITOOL_GRAPHICSACCEL	=	{EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_GRAPHICSACCEL,			1};
  ...
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GUITOOL_ASKSETCACHE =	{EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_ASKSETCACHE,	1};
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GUITOOL_SHOWSIGNOPTIONS =	{EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_SHOWSIGNOPTIONS,	0};
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GUITOOL_SHOWSIGNHELP =	{EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_SHOWSIGNHELP,	1};
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GUITOOL_SIGNSEALOPTIONS =	{EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_SIGNSEALOPTIONS,	3};
...
//AutoUpdates
  ...
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_CMD_USERID = { EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_CMD_USERID, L"default_value" };
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_CMD_PASSWORD = { EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_CMD_PASSWORD, L"default_value" };
  ...
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_OAUTH_HOST = { EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_OAUTH_HOST, L"autenticacao.gov.pt" };
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_OAUTH_PORT = { EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_OAUTH_PORT, L"443" };
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_OAUTH_CLIENTID = { EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_OAUTH_CLIENTID, L"849878956456" };
